<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateCustomer.aspx.cs" Inherits="Testselect.WebForm2" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <p style="margin-left:100px;" class="btn btn-Secondary">
                <asp:Button ID="Button1"  runat="server" OnClick="Button1_Click" Text="Submit" BorderColor="#CCCCCC" CssClass="btn" />
            </p>
        </div>
    </form>
