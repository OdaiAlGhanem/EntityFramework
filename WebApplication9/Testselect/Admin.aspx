...
<body>
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped" AutoGenerateColumns="False" runat="server">
            <Columns>
                <%--<asp:ImageField DataImageUrlField="Photo" HeaderText="photo">
                    <ControlStyle Width="50px" />
                ...
                <asp:HyperLinkField DataNavigateUrlFields="CustomerId" DataNavigateUrlFormatString="~/EditCustomer.aspx?id={0}" Text="Edit" />
                <asp:HyperLinkField DataNavigateUrlFields="CustomerId" DataNavigateUrlFormatString="~/CustomerDelete.aspx?id={0}" Text="Delete" />
            </Columns>
            <%--  <Columns>
